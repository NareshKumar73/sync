...
public class FileController {
	...
	public Mono<Void> downloadFile(
		...
		if (p == null)
			throw new FileNotFoundException("Please check the file list and provide a valid filename or filecode to download.");
		...
		response.getHeaders().setContentType(MediaType.valueOf(Files.probeContentType(p)));
...
//		Files.createFile(p);
//		
//		final AsynchronousFileChannel fileChannel = AsynchronousFileChannel.open(p, StandardOpenOption.WRITE);
//
